...
function initHands() {
  ...
  hands.onResults((results) => {
    ...
    // efecto espejo: la camara entrega la imagen "cruda" (sin invertir), asi que
    // reflejamos horizontalmente para que mover la mano a la derecha se vea a la derecha
